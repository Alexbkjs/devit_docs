...
import { ASSISTANT_CONFIG, getBackendURL } from './config';
import './App.css';
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-700">
            ...
            <li>The backend URL will be automatically detected based on your environment</li>
          ...
          <div className="mt-4 p-3 bg-gray-100 rounded">
            <p className="text-sm text-gray-700">
              <strong>Current backend URL:</strong> <code className="text-blue-600">{backendURL}</code>
            </p>
          </div>
        </div>
      ...
      <AssistantWidget {...ASSISTANT_CONFIG} backendURL={backendURL} />
    </div>
  );
}
